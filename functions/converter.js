...
const notesConverter = async () => {
  ...
  for (const patient of patients) {
    ...
    const note = notes[0];
    const notesJson = {socialHistory:note.notesJson.socialHistory,
      dischargeGoalAndPlan:note.notesJson.dischargeGoalAndPlan,
      officeAdminRecommendations:note.notesJson.officeAdminRecommendations
    } || {};
