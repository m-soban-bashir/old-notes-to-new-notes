...
const notesConverter = async () => {
  ...
  for (const patient of patients) {
    ...
    const note = notes[0];
    const notesJson = {prognosisAndDebility:note.notesJson.prognosisAndDebility,currentHospitalCourse:note.notesJson.currentHospitalCourse,familyHistoryfamilyHistory:note.notesJson.familyHistory} || {};
